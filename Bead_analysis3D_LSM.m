...
% 
% input = .lms images
% output = Results.txt - file gets overwritten as each line is added
%
% NOTE: The program was initially designed to work alongside a timer
% function. The imaging files would be automatically saved after each
% imaging round. The program would scan and identify new timepoints, then
% analyse them and add them to the Results.txt file. 
% 
% Functions required: 
